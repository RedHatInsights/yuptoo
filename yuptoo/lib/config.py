...
KAFKA_CONSUMER_MAXPOLL_INTERVAL = int(os.getenv("KAFKA_CONSUMER_MAXPOLL_INTERVAL", 600000))
...
BYPASS_PAYLOAD_EXPIRATION = os.getenv('BYPASS_PAYLOAD_EXPIRATION', 'false').lower() == 'true'
